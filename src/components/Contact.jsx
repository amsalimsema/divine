...
export default function Component() {
  ...
  return (
    <>
      ...
      <div className='max-w-4xl mx-auto p-4 min-h-full py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-12'>
          <div className='flex flex-col items-center text-center'>
            <Phone className='w-8 h-8 mb-4 text-gray-600' aria-hidden='true' />
          ...
          <div className='flex flex-col items-center text-center'>
            <MapPin className='w-8 h-8 mb-4 text-gray-600' aria-hidden='true' />
