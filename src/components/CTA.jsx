      ...
      <div className='px-6 py-12 sm:px-12 sm:py-16 flex flex-col items-center text-center text-black'>
        ...
        <div className='mt-8'>
          <div className='inline-flex rounded-md shadow'>
            <Link
              to='/contact'
              className='inline-flex items-center justify-center px-5 py-3 border border-[#2ba924] text-base font-medium rounded-md text-white bg-[#2ba924] hover:bg-transparent hover:text-black transition-colors duration-300 shadow-md group'
            >
              Contact Us
