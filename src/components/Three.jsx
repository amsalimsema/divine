...
export default function Footer() {
  return (
    <footer className='bg-white text-black py-16 font-nunito'>
      <div className='max-w-7xl mx-auto px-4 md:px-8 lg:px-16'>
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 text-left'>
          ...
          <div className='col-span-2 lg:col-span-1'>
            <div className='flex flex-col items-start'>
              ...
              />
              <h3 className='text-sm font-semibold mb-2'>Memberships</h3>
              <div className='flex items-center space-x-4'>
                ...
                />
                <img src={UWA} alt='UWA' className='h-20 w-auto' />
                <img
                  src={UTB}
          ...
          <div className='col-span-1 flex flex-col items-start'>
            ...
            <ul className='space-y-2 text-sm'>
              ...
              <li>
                <Link to='/car-hire' className='hover:text-gray-700'>
                  Car Hire
                </Link>
              </li>
              <li>
                <Link to='/destinations' className='hover:text-gray-700'>
                  Tours
                </Link>
              </li>
            </ul>
          ...
          {/* Social Column */}
          <div className='col-span-1 flex flex-col items-start'>
            <h2 className='text-black font-bold mb-4'>Social</h2>
        ...
        {/* Bottom Section */}
        <div className='mt-16 pt-8 border-t border-gray-200 flex flex-col items-center justify-center'>
          {/* Payment Icons */}
          ...
          <div className='text-center'>
            <span className='text-sm text-black hover:text-gray-700'>
